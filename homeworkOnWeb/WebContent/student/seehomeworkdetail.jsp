            ...
            <main id="main-container">
                ...
                <div class="content bg-image overflow-hidden" style="background-image: url('assets/img/photos/photo12@2x.jpg');">
                    <div class="push-50-t push-15">
                        <h1 class="h2 text-white animated zoomIn">查看作业</h1>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                   			<div class="row">
                   				<div class="col-xs-3">
                   				<ul class="nav nav-tabs nav-stacked " id="excontent">
                   				<%
                   				Homework homework = studentDao.setHomework(request.getParameter("homeworkID"));
...
<div class="col-xs-9">
                        ...
                        <div id="myTabContent" class="tab-content">
                   		...
                   		<%
                            	...
                            	j = 1;
											...
											for (Question question : homework.getQuestions()) {
													String workID_exID = "work"  + "_ex" + j;
													String answerareaID = "answerareawork" + "_ex" + j;
                        ...
                        <button type="button" class="btn btn-defalut" ONCLICK="window.location.href('seehomework.jsp')">查看其他作业</button>
