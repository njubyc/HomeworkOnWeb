                        ...
                        <div class="block-content">
                           <div class="block-content">
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <tbody>
                                 <%
                                 List<Class> classes =assteacherDao.showClasses(assteacher.getAssTeacherID(),"all");
                                                ...
                                                <table class="table remove-margin-b font-s13">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="font-w600 text-success text-right" style="width: 70px;"><%=assteacher.getAssTeacherID() %></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="font-w600">姓名：</td>
                                                            
                                                            <td class="font-w600 text-success text-right"><%=assteacher.getName() %></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
